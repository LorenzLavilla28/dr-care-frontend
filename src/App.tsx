...
function PublicEventPage({ token }: { token: string }) {
  ...
  const [form, setForm] = useState({ fullName: "", contactNumber: "", email: "", address: "", preferredLocation: "", sourceOfIncome: "", productLine: "", assistedByUserId: "", consentAccepted: false });
